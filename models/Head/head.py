...
from .attentionfusion import CrossAttentionFusion, MultiCrossAttentionFusion, AttentionFusionBlock, CrossViewCrossAttention
...
class Head(nn.Module):
    ...
    def init_head(self, head_opt):
        ...
        elif head == "CrossViewCrossAttention":
            head_model = CrossViewCrossAttention(self.opt)
        else:
